...
# ln(E) against latitude, trait identity, or just an intercept, using 
# MCMCglmm.
#
...
all_dat_E$Absolute_latitude <- abs(all_dat_E$Latitude)
all_dat_E$Latitude_rad <- all_dat_E$Latitude * pi/180
...
# Fit the models.
set.seed(1)
fit_1a <- MCMCglmm(ln_E ~ cos(Latitude_rad) + Trait, family = "gaussian",
...
set.seed(2)
fit_1b <- MCMCglmm(ln_E ~ cos(Latitude_rad) + Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(3)
fit_2a <- MCMCglmm(ln_E ~ cos(Latitude_rad)*Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(4)
fit_2b <- MCMCglmm(ln_E ~ cos(Latitude_rad)*Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(5)
fit_3a <- MCMCglmm(ln_E ~ cos(Latitude_rad), family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(6)
fit_3b <- MCMCglmm(ln_E ~ cos(Latitude_rad), family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(11)
fit_6a <- MCMCglmm(ln_E ~ Absolute_latitude + Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(12)
fit_6b <- MCMCglmm(ln_E ~ Absolute_latitude + Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(13)
fit_7a <- MCMCglmm(ln_E ~ Absolute_latitude*Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(14)
fit_7b <- MCMCglmm(ln_E ~ Absolute_latitude*Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(15)
fit_8a <- MCMCglmm(ln_E ~ Absolute_latitude, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(16)
fit_8b <- MCMCglmm(ln_E ~ Absolute_latitude, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(17)
fit_1a_NON_PHYLO <- MCMCglmm(ln_E ~ cos(Latitude_rad) + Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(18)
fit_1b_NON_PHYLO <- MCMCglmm(ln_E ~ cos(Latitude_rad) + Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(19)
fit_2a_NON_PHYLO <- MCMCglmm(ln_E ~ cos(Latitude_rad)*Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(20)
fit_2b_NON_PHYLO <- MCMCglmm(ln_E ~ cos(Latitude_rad)*Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(21)
fit_3a_NON_PHYLO <- MCMCglmm(ln_E ~ cos(Latitude_rad), family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(22)
fit_3b_NON_PHYLO <- MCMCglmm(ln_E ~ cos(Latitude_rad), family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(27)
fit_6a_NON_PHYLO <- MCMCglmm(ln_E ~ Absolute_latitude + Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(28)
fit_6b_NON_PHYLO <- MCMCglmm(ln_E ~ Absolute_latitude + Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(29)
fit_7a_NON_PHYLO <- MCMCglmm(ln_E ~ Absolute_latitude*Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(30)
fit_7b_NON_PHYLO <- MCMCglmm(ln_E ~ Absolute_latitude*Trait, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(31)
fit_8a_NON_PHYLO <- MCMCglmm(ln_E ~ Absolute_latitude, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
set.seed(32)
fit_8b_NON_PHYLO <- MCMCglmm(ln_E ~ Absolute_latitude, family = "gaussian",
    prior=list(G=list(G1=list(V=diag(1),nu=1.002)), R=list(V=diag(1),nu=1.002)),
    random=~Species,
    data = all_dat_E,
    nitt = 5000000,
...
# fixed effects of absolute latitude and trait identiy, and with a 
